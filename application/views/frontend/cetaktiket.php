...
<body onload="window.print()">
  ...
  <div id="container">
    ...
    <div id="body">
        <ol type="1">
          <li>Go-Bus * ONLY bus ticket agents. It does not operate the bus service itself. In order to provide a comprehensive choice of bus operators, departure times and prices for customers, it has tied up with many bus operators.
          Go-Bus advice to customers is to choose a bus operator they know from and whose service they are comfortable with.</li>
          <li>The departure time stated on the ticket is only a tentative time. However, the bus will not leave the source before the time stated on the ticket. Passengers are required to provide the following when boarding the bus:
           ...
           <li>Go-Bus responsibilities include:
           ...
           Change bus: If the bus operator changes the bus type for some reason, Go-Bus will refund the differential amount to the customer after being intimidated by the customer within 24 hours of travel.</li>
        <li>Go-Bus's liability does NOT include:
        ...
        write your cash coupon details to support@Go-Bus.web</li>
        </ol>  
    </div>
</div>
